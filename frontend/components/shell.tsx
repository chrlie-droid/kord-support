...
import { BookOpen, Building2, Home, LifeBuoy, Settings, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50">
      <aside className="fixed inset-y-0 left-0 hidden w-64 border-r bg-slate-950 text-white md:block">
        <div className="px-6 py-6">
          ...
          <div className="mt-1 text-xs text-slate-400">операционная система поддержки</div>
        </div>
      ...
      <div className="md:pl-64">
        <header className="sticky top-0 z-10 border-b bg-white/90 backdrop-blur">
          <div className="flex h-16 items-center justify-between px-6">
            <div>
              <div className="font-semibold">Рабочее место инженера</div>
              <div className="text-xs text-slate-500">CRM · Service Desk · Паспорт объекта · База знаний</div>
            </div>
            <div className="rounded-full bg-slate-100 px-3 py-1 text-sm text-slate-700">admin@kord.local</div>
          </div>
        </header>
